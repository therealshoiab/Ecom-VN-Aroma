  ...
  try {
    ...
    const perfumesData = [
      ...
      },
      {
        ...
        name: 'Pear Sorbet',
        slug: 'pear-sorbet',
        tagline: 'Frosted green pear, icy mint, and cold marble.',
        description: 'A refreshing, crystalline summer delicacy. Frosted green pear and sweet melon slices sit on a cold marble slab, accompanied by a bowl of fresh green pears and a crisp icy mint leaf.',
        price: 5100,
        compareAtPrice: null,
      ...
      },
      {
        ...
        name: 'Wild Bluebell',
        slug: 'wild-bluebell',
        tagline: 'Dewy bluebell blossoms, white wood, and powdery musk.',
        description: 'A delicate, dreamlike floral fragrance. Freshly bloomed wild bluebell flowers are cradled on soft white wood, surrounded by the morning dew and soft powdery musk.',
        price: 4800,
        compareAtPrice: 5800,
      ...
      },
      {
        ...
        name: 'Apricot Nectar',
        slug: 'apricot-nectar',
        tagline: 'Sun-drenched apricot flesh, white cloth, and sweet kitchen warmth.',
        description: 'A succulent, gourmand fruit creation. Plump, ripe apricot halves sit on a clean white cloth next to a bowl of fresh apricots, releasing sweet peach-like nectar and warm vanilla notes.',
        price: 5800,
        compareAtPrice: 6800,
      ...
      },
      {
        ...
        name: 'Sunny Mimosa',
        slug: 'sunny-mimosa',
        tagline: 'Fresh yellow mimosa branches, morning tea, and warm croissants.',
        description: 'A warm, cheerful, and sunny gourmand floral. Fluffy yellow mimosa flower branches rest on a white tablecloth next to a cup of morning black tea and a warm flaky croissant, reflecting sunbeams.',
        price: 5100,
        compareAtPrice: 6200,
      ...
      },
      {
        ...
        name: 'Cherry Blossom',
        slug: 'cherry-blossom',
        tagline: 'Sweet cherry blossom petals, white marble stand, and soft pink mist.',
        description: 'A romantic, powdery-fresh spring floral. Elegant cherry blossom branches rest on a polished round marble table, releasing a sweet pink floral mist under soft morning sunlight.',
        price: 5200,
        compareAtPrice: null,
